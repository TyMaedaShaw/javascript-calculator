...
return (
    <div className="container">
        <div className="grid">
         ...
         <div onClick={allClear} className="padButton AC ninjin">AC</div>
         <div onClick={clear} className="padButton C ninjin">C</div>
         ...
         <div onClick={() => display("-")} className="padButton sub">-</div>
         ...
         <div onClick={() => display("+")} className="padButton add">+</div>
         ...
         <div onClick={() => display(".")} className="padButton dec dark-gray">.</div>
        </div>
    </div>
